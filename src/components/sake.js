...
class Sake extends Component {
  ...
  componentDidMount() {
    ...
    fetch(`http://foaas.com/sake/${from}`, {
      headers: {
    ...
    .then((json) => {
      ...
      this.setState({message: "For fig's sake!"});
  ...
  componentWillShout() {
    const from = this.state.from;
    fetch(`http://foaas.com/sake/${from}?shoutcloud`, {
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
      },
  ...
  inGerman() {
    const from = this.state.from;
    fetch(`http://foaas.com/sake/${from}?shoutcloud&i18n=de`, {
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
      },
  ...
  inSpanish() {
    const from = this.state.from;
    fetch(`http://foaas.com/sake/${from}?i18n=es`, {
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
      },
  ...
  inFrench() {
    const from = this.state.from;
    fetch(`http://foaas.com/sake/${from}?i18n=fr`, {
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
      },
  ...
  inKorean() {
    const from = this.state.from;
    fetch(`http://foaas.com/sake/${from}?i18n=ko`, {
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
      },
  ...
  inRussian() {
    const from = this.state.from;
    fetch(`http://foaas.com/sake/${from}?i18n=ru`, {
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
      },
  ...
  inCanadian() {
    ...
    .then((json) => {
      let message = json.message;
      let subtitle = json.subtitle;
      this.setState({message: "It's pretty irritating, eh?"});
